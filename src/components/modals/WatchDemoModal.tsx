      ...
      >
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-[#6c6a64] font-mono">Experience how daily streak tracking boosts consistency.</p>
          </div>
        </div>
        ...
        >
          <div className="flex items-center justify-between text-xs font-mono">
            <span className="flex items-center gap-1.5 text-[#cc785c] font-bold">
              <Flame className="w-4 h-4 fire-animated" /> Live Interactive Demo Mode
            </span>
            <span className="text-[#8e8b82]">02:45 / 03:00</span>
          </div>
          ...
          <div 
            ...
            style={{ background: 'rgba(204, 120, 92, 0.08)' }}
          >
            <div className="w-3/4 h-full" style={{ background: '#5db8a6' }} />
          </div>
        </div>

        <div className="flex items-center justify-between pt-2">
          <span className="text-xs text-[#8e8b82] font-mono">Ready to try it yourself?</span>
          <button
            onClick={() => {
